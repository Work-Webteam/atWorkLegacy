...
$ministries = array(
  "1" => "Advanced Education & Skills Training",
  "2" => "Agriculture, Food and Fisheries",
  "3" => "Attorney General",
  "4" => "Children and Family Development",
  "5" => "Citizens' Services ",
  "6" => "Education",
  "7" => "Energy, Mines and Low Carbon Innovation",
  ...
  "15" => "Jobs, Economic Recovery and Innovation",
  "16" => "Labour",
  "17" => "Mental Health and Addictions",
  "18" => "Municipal Affairs",
  "19" => "Public Safety & Solicitor General & Emergency B.C.",
  "20" => "Social Development and Poverty Reduction",
  "21" => "Tourism, Arts, Culture and Sport",
