...
function WebTrends(){
	...
	this.fpcdom="";
	this.onsitedoms="";
	this.downloadtypes="xls,xlsx,doc,docx,dotx,pdf,txt,csv,zip,mov,axd,mpeg,swf,mp3,m4v,potx,ppt,pptx,pps,ppsx,lpt,tar,sit,arj";
	this.navigationtag="div,table";
	this.metanames="WT.owner,WT.audience,WT.theme,WT.subject";
