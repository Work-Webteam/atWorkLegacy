 ...
 * @param $view
 *
 * Need to change the wording on blocks for the home page.
 */
function atwork_zen_views_pre_render($view) {
  ...
  if($view->name == 'home_page_blocks_zen' && ($view->current_display == 'block_1' || $view->current_display == 'block_4' || $view->current_display == 'block_3' )){
