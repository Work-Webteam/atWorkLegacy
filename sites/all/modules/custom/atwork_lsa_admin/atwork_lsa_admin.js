(function ($) {
  ...
  $(document).ready(function () {
    var awardName = $(".field-name-field-lsa-award .field-item.odd").text();
	  ...
	  var selectedImageURI = giftImages[awardName.trim()]; 
	  ...
	  $(".lsa-award-selector-img-display-panel").css({"border-radius":"9px","box-shadow":"2px 2px lightgrey","padding":"10px","border":"1px solid gray","margin":"30px 0 20px 50px"}).attr({"src":selectedImageURI});  
  });
