(function ($) {
  ...
  Drupal.behaviors.profileFeedJquery = {
    attach: function (context, settings) {
      ...
      // Focus doesn't seem to fire on reload.
      $(window).load(function(){
        setFeedInterval();
      });

      // Start checking db for new messages when window is in focus
  ...
  /**
   * Function in charge of setting the interval to the value we would like, checks for new messages
   */
  ...
  /**
   * Function in charge of setting interval to 0 on blur
   */
  function stopFeedInterval() {
    clearInterval(refreshFeed);
    refreshFeed = false;
    // TODO: Possibly allow this to update very few minutes or more, even while user away? - In case they have sidebar opened on side of browser?
  }
