function Browseris () {
  ...
  // Atwork team added this because of ie8 compatibility mode problems
  if (this.ie7) {
    this.ie7=false;
    this.ie8=true;
  }
...
function IMNGetOOUILocation(obj)
{
	...
	objRet.oouiX=oouiX;
	__scrollTop = (browseris.ie8)?document.body.parentNode.scrollTop: ((browseris.ie7)?document.body.scrollTop : 0);
	objRet.oouiY=oouiY - __scrollTop
	if (fRtl)
